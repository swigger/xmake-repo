...
* Windows (x86, x64)
* macOS (i386, x86\_64, arm64)
* Linux (i386, x86\_64, cross-toolchains ..)
* \*BSD (i386, x86\_64)
* Android (x86, x86\_64, armeabi, armeabi-v7a, arm64-v8a)
* iOS (armv7, armv7s, arm64, i386, x86\_64)
* MSYS (i386, x86\_64)
* MinGW (i386, x86\_64, arm, arm64)
* Cross Toolchains
